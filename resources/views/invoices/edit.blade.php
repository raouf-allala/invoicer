            ...
            <form method="post" action="{{ route('invoices.update', $invoice) }}"
                ...
                <div class="max-w-[800px] mx-auto bg-white p-8 text-sm text-black font-sans shadow-lg">
                    ...
                    <div class="flex justify-between mb-8">
                        ...
                        <div class="w-1/3">
                            <div class="grid grid-cols-2 gap-y-1 text-sm items-center">
                                ...
                                <div>
                                    {{ \Carbon\Carbon::parse($invoice->invoice_date)->locale('fr')->isoFormat('DD MMMM YYYY') }}
                                </div>
                    ...
                    <div class="flex justify-end gap-4 mt-8">
                        ...
                        <button type="submit"
                            class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">{{ __('Update Invoice') }}</button>
                    </div>
                </div>
            </form>
        </div>
