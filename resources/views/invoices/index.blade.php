	...
	<div class="py-6">
		<div class="mx-auto max-w-7xl sm:px-6 lg:px-8 space-y-6">
			...
			<div
				...
				<form class="flex flex-wrap gap-4 w-full" action="{{ route('invoices.index') }}" method="GET" x-data
				...
				@forelse ($invoices as $invoice)
					<tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
						<x-table.td class="font-medium text-gray-900 dark:text-white">
							<a href="{{ route('invoices.show', $invoice->invoice_number) }}" class="hover:underline">
